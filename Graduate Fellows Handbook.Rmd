...
Step 4: Look for workshop you are working      
...
Step 5: Fill in meeting information on Zoom then click save,   
...
Step 7: On meeting tab, it should there    
...
Localist
o	Start by copying an old event
	Make sure you are working on copy
o	Fill in all information (Like below)
	Click “Include Above in Schedule”
	Delete the old Confirmed dates
	Description is made from Instructor’s meeting
Pic 1

o	Fill out Location (Like below)
	Check if event is only in-person, only virtual or hybrid
Pic2

o	Change the Owner to yourself 	
	Check Vanity URL (qcl_workshop_stata_fa21_1117)
pic3

o	Add a Ticket Types
	Virtual or In-Person (or both)
	Make sure Virtual is always on Top
pic4

o	Add a Virtual ticket name is ZOOM and drag to the right ticket type (pic wrong)
	Then go into additional ticket options
pic5

o	Check to make sure settings are correct
o	Make sure Ticket availability dates correctly dated or left blank if you will manual turn off
pic6

o	Add in-person ticket named QCL CLASSROOM and drag to the right ticket type  (pic wrong)
	Then go into additional ticket options
pic7

o	Check to make sure setting are correct
pic8


o	Check to make sure that Attendees Questions are correct
...
o	Check to make sure you have the correct Event Capacity
pic10
...
o	Send Dr. Park an email + post a message on Teams so that I can announce them.
pic 11
