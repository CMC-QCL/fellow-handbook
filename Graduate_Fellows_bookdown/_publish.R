...
i = 1
s = paste0('title: "Graduate Fellows Handbook (', c('Bootstrap', 'Tufte'), ' Style)"')
for (fmt in c('html_book', 'tufte_html_book')) {
  ...
  i = i + 1
  bookdown::publish_book(paste0('Graduate Fellows Handbook', i))
}
unlink('_book', recursive = TRUE)
...
bookdown::publish_book('Graduate Fellows Handbook')
